  ...
  namespace utils
  {
    ...
    class Color
    {
      ...
      public:
        ...
        NOISE_EXPORT Color (noise::uint8 r, noise::uint8 g, noise::uint8 b,
          noise::uint8 a):
    ...
    class GradientColor
    {
      ...
      public:
        ...
        NOISE_EXPORT void AddGradientPoint (double gradientPos,
        ...
        NOISE_EXPORT const Color& GetColor (double gradientPos) const;
        ...
        NOISE_EXPORT const GradientPoint* GetGradientPointArray () const
        {
        ...
        ///
        /// @returns The number of gradient points stored in this object.
        NOISE_EXPORT int GetGradientPointCount () const
        {
    ...
    class NoiseMap
    {
      ...
      public:
        ...
        /// positive.
        NOISE_EXPORT NoiseMap (int width, int height);

        /// Copy constructor.
        ///
        /// @throw noise::ExceptionOutOfMemory Out of memory.
        NOISE_EXPORT NoiseMap (const NoiseMap& rhs);
        ...
        NOISE_EXPORT float GetValue (int x, int y) const;
        ...
        /// unmodified.
        NOISE_EXPORT void SetSize (int width, int height);
        ...
        NOISE_EXPORT void SetValue (int x, int y, float value);
        ...
        /// quick.
        NOISE_EXPORT void TakeOwnership (NoiseMap& source);
    ...
    class Image
    {
      ...
      public:
        ...
        /// It is considered an error if the specified dimensions are not
        /// positive.
        NOISE_EXPORT Image (int width, int height);

        /// Copy constructor.
        ///
        /// @throw noise::ExceptionOutOfMemory Out of memory.
        NOISE_EXPORT Image  (const Image& rhs);
        ...
        NOISE_EXPORT Color GetValue (int x, int y) const;
        ...
        NOISE_EXPORT void SetValue (int x, int y, const Color& value);
        ...
        /// This method only moves the buffer pointer so this method is very
        /// quick.
        NOISE_EXPORT void TakeOwnership (Image& source);
    ...
    class WriterBMP
    {
      ...
      public:
        ...
        NOISE_EXPORT void WriteDestFile ();
    ...
    class NoiseMapBuilder
    {
      ...
      public:
        ...
        /// SetSourceModule().
        NOISE_EXPORT virtual void Build () = 0;
        ...
        /// method.
        NOISE_EXPORT void SetCallback (NoiseMapCallback pCallback);
    ...
    class NoiseMapBuilderCylinder: public NoiseMapBuilder
    {
      ...
      public:
        ...
        /// Constructor.
        NOISE_EXPORT NoiseMapBuilderCylinder ();

        NOISE_EXPORT virtual void Build ();
    ...
    class NoiseMapBuilderPlane: public NoiseMapBuilder
    {
      ...
      public:
        ...
        /// Constructor.
        NOISE_EXPORT NoiseMapBuilderPlane ();
    ...
    class NoiseMapBuilderSphere: public NoiseMapBuilder
    {
      ...
      public:
        ...
        /// Constructor.
        NOISE_EXPORT NoiseMapBuilderSphere ();
    ...
    class RendererImage
    {
      ...
      public:
        ...
        /// - -1.0 maps to black
        /// - 1.0 maps to white
        NOISE_EXPORT void BuildGrayscaleGradient ();
        ...
        NOISE_EXPORT void BuildTerrainGradient ();
        ...
        NOISE_EXPORT void ClearGradient ();
    ...
    class RendererNormalMap
    {
      ...
      public:
        ...
        /// Constructor.
        NOISE_EXPORT RendererNormalMap ();
